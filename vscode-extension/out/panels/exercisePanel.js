...
exports.ExercisePanelManager = void 0;
const vscode = __importStar(require("vscode"));
class ExercisePanelManager {
    constructor(panel, context, apiService) {
    ...
    static createOrShowPanel(context, apiService) {
        ...
        const panel = vscode.window.createWebviewPanel('treinoProExercises', 'Treino Pro - Exercicios', column || vscode.ViewColumn.One, {
            enableScripts: true,
...
exports.ExercisePanelManager = ExercisePanelManager;
//# sourceMappingURL=exercisePanel.js.map