...
exports.NorminetteService = exports.NORM_RULES = void 0;
...
class NorminetteService {
    ...
    async checkWithOfficialNorminette(filePath) {
        try {
            const platformService = (0, platformService_1.getPlatformService)();
    ...
    parseNorminetteOutput(output) {
        ...
        for (const line of lines) {
            ...
            if (match) {
                ...
                const code = match[2];
                const ruleInfo = exports.NORM_RULES[code];
                const severity = severityInput === 'error' ? 'error' :
    ...
    async checkLocal(filePath) {
        ...
        if (!this.checkHeader42(content, lines)) {
            errors.push({
                ...
                message: exports.NORM_RULES.HEADER_MISSING.message,
        ...
        if (filePath.endsWith('.h')) {
            if (!this.checkIncludeGuard(content)) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.INCLUDE_GUARD.message,
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (line.length > 80) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.LINE_TOO_LONG.message} (${line.length} caracteres)`,
            ...
            if (trailingMatch && line.length > 0) {
                errors.push({
                    ...
                    code: 'SPC_BEFORE_NL', message: exports.NORM_RULES.SPC_BEFORE_NL.message,
            ...
            if (indentMatch) {
                ...
                if (indent.includes(' ') && !indent.startsWith('\t')) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.SPACE_INDENT.message,
                ...
                if (/\t /.test(indent) || / \t/.test(indent)) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.MIXED_INDENT.message,
            ...
            if (trimmedLine === '') {
                if (lastLineEmpty) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.MULT_EMPTY_LINE.message,
            ...
            if (/,[^\s\n]/.test(line) && !line.includes('#include')) {
                ...
                for (const match of matches) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.SPC_AFTER_COMMA.message,
            ...
            if (/ ,/.test(line)) {
                ...
                for (const match of matches) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.SPC_BEFORE_COMMA.message,
            ...
            for (const match of keywordNoSpaceMatches) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.SPACE_AFTER_KW.message}: ${match[1]}`,
            ...
            if (/\( /.test(line) && !/\( \*/.test(line)) {
                ...
                for (const match of matches) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.SPC_AFTER_PAR.message,
            ...
            if (/ \)/.test(line)) {
                ...
                for (const match of matches) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.SPC_BFR_PAR.message,
            ...
            if (structMatch && !structMatch[1].startsWith('s_')) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.STRUCT_PREFIX.message}: ${structMatch[1]}`,
            ...
            if (enumMatch && !enumMatch[1].startsWith('e_')) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.ENUM_PREFIX.message}: ${enumMatch[1]}`,
            ...
            if (unionMatch && !unionMatch[1].startsWith('u_')) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.UNION_PREFIX.message}: ${unionMatch[1]}`,
            ...
            if (typedefMatch && !typedefMatch[1].endsWith('_t')) {
                errors.push({
                    ...
                    message: `${exports.NORM_RULES.TYPEDEF_SUFFIX.message}: ${typedefMatch[1]}`,
            ...
            if (funcStartMatch && i > 0 && /^(void|int|char|float|double|long|short|unsigned|signed|t_\w+)\s*\**\s*$/.test(lines[i - 1].trim())) {
                ...
                if (functionCount > 5) {
                    errors.push({
                        ...
                        message: `${exports.NORM_RULES.TOO_MANY_FUNCS.message} (${functionCount} funcoes)`,
            ...
            if (emptyParamMatch && !line.includes('typedef') && !line.includes('#define')) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.MISSING_VOID_PARAM.message,
            ...
            if (paramMatch && !line.includes('#define') && !line.includes('//')) {
                ...
                if (params.length > 4) {
                    errors.push({
                        ...
                        message: `${exports.NORM_RULES.TOO_MANY_ARGS.message} (${params.length} parametros)`,
            ...
            if (braceDepth > 4) { // 1 para funcao + 3 de aninhamento
                errors.push({
                    ...
                    message: exports.NORM_RULES.NESTED_TOO_DEEP.message,
            ...
            if (inFunction && trimmedLine !== '' && !trimmedLine.startsWith('{') && !trimmedLine.startsWith('}')) {
                ...
                if (functionLines > 25) {
                    errors.push({
                        ...
                        message: `${exports.NORM_RULES.FUNC_TOO_LONG.message} (linha ${functionLines})`,
                ...
                if (varDeclMatch) {
                    ...
                    if (varCount > 5) {
                        errors.push({
                            ...
                            message: `${exports.NORM_RULES.TOO_MANY_VARS.message} (${varCount} variaveis)`,
                ...
                if (globalVarMatch && !line.includes('(') && !line.includes('typedef') && !line.includes('extern')) {
                    ...
                    if (!globalVarMatch[2].startsWith('g_')) {
                        errors.push({
                            ...
                            message: `${exports.NORM_RULES.GLOBAL_PREFIX.message}: ${globalVarMatch[2]}`,
            ...
            if (inFunction) {
                ...
                if (declAssignMatch && !line.includes('static') && !line.includes('const')) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.DECL_ASSIGN.message,
            ...
            if (/\?.*:/.test(line) && !line.includes('#') && !line.includes('//')) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.TERNARY_FBIDDEN.message,
            ...
            if (/\bgoto\b/.test(line)) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.GOTO_FBIDDEN.message,
            ...
            if (/\[[a-z_][a-z0-9_]*\]/i.test(line) && !line.includes('#define')) {
                ...
                if (vlaMatch) {
                    errors.push({
                        ...
                        message: exports.NORM_RULES.VLA_FORBIDDEN.message,
            ...
            if (returnMatch) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.RETURN_PARENTHESES.message,
            ...
            if (defineMatch) {
                ...
                if (!macroName.endsWith('_H') && macroName !== macroName.toUpperCase()) {
                    errors.push({
                        ...
                        message: `${exports.NORM_RULES.MACRO_CASE.message}: ${macroName}`,
            ...
            if (line.includes('//') && !line.includes('http://') && !line.includes('https://')) {
                errors.push({
                    ...
                    message: exports.NORM_RULES.CPP_COMMENT.message,
        ...
        if (!content.endsWith('\n')) {
            errors.push({
                ...
                message: exports.NORM_RULES.NO_NL_AT_EOF.message,
        ...
        if (lines[0]?.trim() === '' && !lines[0].includes('/*')) {
            errors.push({
                ...
                message: exports.NORM_RULES.EMPTY_LINE_FILE_START.message,
    ...
    formatOutput(errors) {
        ...
        return errors.map(e => `${e.severity === 'error' ? 'Error' : 'Warning'}: ${e.code} (line: ${e.line}, col: ${e.column}): ${e.message}`).join('\n');
    }
    ...
    parseToDiagnostics(result, uri) {
        return result.errors.map(error => {
            ...
            const range = new vscode.Range(Math.max(0, error.line - 1), Math.max(0, error.column - 1), Math.max(0, error.line - 1), error.column + 50);
    ...
    updateDiagnostics(diagnostics, uri) {
    ...
    generateHeader42(fileName, author = 'marvin') {
        const now = new Date();
...
exports.NorminetteService = NorminetteService;
//# sourceMappingURL=norminetteService.js.map